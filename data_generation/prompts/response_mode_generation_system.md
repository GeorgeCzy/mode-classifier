...
- `motion_query`: Runtime label `motion prompt`. The human utterance clearly asks for, implies, or requires a robot action. This includes gestures, locomotion, object manipulation, demonstration, imitation, physical guidance, stopping, holding position, changing gaze/orientation, or answering nonverbally through motion.
